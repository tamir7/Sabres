...
/**
 * The Sabres class contains static functions that handle global configuration and debug faculties
 * for the Sabres library.
 */
public final class Sabres {
    ...
    /**
     * Setting the debug flag to true will start printing all sql commands generated by the
     * Sabres library.
     *
     * @param debug true to print all sql commands, false to disable printing.
     */
    ...
    /**
     * Prints all tables that exist in Sabres with row counts.
     */
     ...
     *
     * @param clazz The object class to print.
     */
    public static <T extends SabresObject> void printSchema(Class<T> clazz) {
